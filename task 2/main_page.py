...
if page == "Home":
    ...
    image_path = "C:\\Users\\lenovo\\OneDrive\\Desktop\\task2\\task2\\PLANT DISEASE RECOGNITION SYSTEM1.JPG"
...
# How It Works Page
    ...
    st.header("PLANT DISEASE RECOGNITION SYSTEM")
    image_path = "C:\\Users\\lenovo\\OneDrive\\Desktop\\task2\\task2\\PLANT DISEASE RECOGNITION SYSTEM2.JPG"
    st.image(image_path, use_column_width=True)
    st.markdown("""
         Welcome to the Plant Disease Recognition System! 🌿🔍
...
# About Page
    ...
    st.header("PLANT DISEASE RECOGNITION SYSTEM")
    image_path = "C:\\Users\\lenovo\\OneDrive\\Desktop\\task2\\task2\\PLANT DISEASE RECOGNITION SYSTEM3.JPG"
    st.image(image_path, use_column_width=True)
    st.markdown("""
         Welcome to the Plant Disease Recognition System! 🌿🔍
